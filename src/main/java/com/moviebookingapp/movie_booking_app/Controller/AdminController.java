...
public class AdminController {
    ...
    public ResponseEntity<?> getBookedTicketsAndUpdateStatus(@PathVariable String movieName,
        ...
        return ResponseEntity.ok(String.format("Booked: %d, Available: %d, Status: %s", booked, available, movie.getStatus()));
    }
